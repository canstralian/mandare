...
def test_version_matches_pyproject() -> None:
    ...
    assert mandare.__version__ == expected
...
def test_read_version_from_pyproject_path_resolution() -> None:
    ...
    from mandare._version import _read_version_from_pyproject
...
def test_version_falls_back_to_pyproject(
    ...
    monkeypatch.setattr(
        "mandare._version._read_version_from_pyproject", lambda: "9.8.7"
    )

    from mandare._version import _read_version
...
def test_version_unknown_when_all_fallbacks_fail(
    ...
    monkeypatch.setattr("mandare._version._read_version_from_pyproject", lambda: None)
...
def test_api_app_version_matches_the_package() -> None:
    ...
    """
    from mandare import __version__
