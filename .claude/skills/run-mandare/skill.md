---
name: run-mandare
description: Develop, review, and evolve the Mandare while preserving architectural contracts, governance, evidence, replay, and quality standards.
---
...
You are an engineering agent for the Mandare.
