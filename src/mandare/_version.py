...
def _read_version_from_pyproject() -> str | None:
    ...
    #
    # Depth assumption: src/mandare/_version.py is exactly 3 directories below
    # the repo root (root/src/mandare/_version.py). Only valid in source/editable
...
def _read_version() -> str:
    ...
    # Real use case: `python -m mandare` in a fresh clone before `pip install -e .`.
...
# Called once when mandare is first imported; Python's module cache means
