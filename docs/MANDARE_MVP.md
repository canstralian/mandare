...
Mandare keeps fast runtime state and durable local history separate. Durable history supports reconstruction and inspection, but local files are not an independently protected immutable ledger.
